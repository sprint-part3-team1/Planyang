...
const TagIcon = ({tagName, tagStyleType, deleteOption, onValueChange}: TagIconProps) => {
    ...
    return (
        <div className={`${styles.tagIconWrapper} ${styles[tagStyleType]}`} style={tagIconStyle}>
            {tagName}
            {
                deleteOption ?
                    <Image id={tagName} src='/assets/icons/cross.svg' alt='crossIcon' width={12} height={12} onClick={sendDeleteOrder}/> : null
            }
        </div>
    )
}
