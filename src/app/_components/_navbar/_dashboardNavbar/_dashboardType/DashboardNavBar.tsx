...
const DashboardNavBar = ({membersInfo, createdByMe, dashboardTitle, nickname, profileImageUrl}: DashboardNavBarProps) => {
    const onClickButton = () => {
        console.log(' ');
    }
    ...
    return (
        <div className={styles.navbarWrapper}>
            <div className={styles.navBarInfoWrapper}>
                ...
                {
                    createdByMe && <Image src='/assets/icons/crown.svg' alt='crownIcon' width={20} height={20} />
                }
            </div>
            <div className={styles.sideMenuWrapper}>
                ...
                <UserIconList members={membersInfo.members} totalCount={membersInfo.totalCount}></UserIconList>
                <Contour />
